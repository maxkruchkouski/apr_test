...
def test_authorization_with_phone_number_ru(driver):
...
def test_authorization_with_phone_number_ua(driver):
...
def test_authorization_with_e_mail_ru(driver,):
    driver.get("https://ion.ua/")
    home_page = HomePage(driver)
    name_button_before_login = home_page.get_name_personal_area()
    home_page.open_pop_up_privat_area()
...
def test_authorization_with_e_mail_ua(driver,):
    driver.get("https://ion.ua/ua")
    home_page = HomePage(driver)
    name_button_before_login = home_page.get_name_personal_area()
    home_page.open_pop_up_privat_area()
...
def test_authorization_google_id_ru(driver):
    driver.get("https://ion.ua/")
    home_page = HomePage(driver)
    name_button_before_login = home_page.get_name_personal_area()
    home_page.open_pop_up_privat_area()
...
def test_authorization_google_id_ua(driver):
    driver.get("https://ion.ua/ua")
    home_page = HomePage(driver)
    name_button_before_login = home_page.get_name_personal_area()
    home_page.open_pop_up_privat_area()
...
def test_authorization_facebook_id_ru(driver):
    driver.get("https://ion.ua/")
...
@pytest.mark.skip(reason='https://asbisc.atlassian.net/browse/APR-500')
def test_authorization_facebook_id_ua(driver):
    driver.get("https://ion.ua/ua")
    # driver.save_screenshot("screenshot.png")
    home_page = HomePage(driver)
    name_button_before_login = home_page.get_name_personal_area()
