...
def test_authorization_with_phone_number_az(driver):
...
def test_authorization_with_e_mail_az(driver,):
    driver.get("https://almastore.az/")
    home_page = HomePage(driver)
    name_button_before_login = home_page.get_name_personal_area()
    home_page.open_pop_up_privat_area()
...
def test_authorization_google_id_az(driver):
    driver.get("https://almastore.az/")
    home_page = HomePage(driver)
    name_button_before_login = home_page.get_name_personal_area()
    home_page.open_pop_up_privat_area()
...
@pytest.mark.skip(reason='https://asbisc.atlassian.net/browse/APR-500')
def test_authorization_facebook_id_az(driver):
    driver.get("https://almastore.az/")
    # driver.save_screenshot("screenshot.png")
    home_page = HomePage(driver)
    name_button_before_login = home_page.get_name_personal_area()
