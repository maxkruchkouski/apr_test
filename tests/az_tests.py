...
#     name_button_before_login = home_page.get_name_personal_area()
#     home_page.open_pop_up_privat_area()
#     home_page.click_button_google_id()
...
#
#
# def test_add_product_in_stock_in_cart(driver):#TODO
#     site = SITES(driver)
#     site.go_to_site_az_ru()
#     home_page = HomePage(driver)
#     time.sleep(1)
...
#
# def test_add_product_in_preorder_in_cart(driver):#TODO
#     site = SITES(driver)
#     site.go_to_site_az_ru()
#     home_page = HomePage(driver)
#     time.sleep(1)
