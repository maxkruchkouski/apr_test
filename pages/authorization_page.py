...
class Authorization(BasePage):
    ...
    def enter_login_tel(self):
        self.find_element(authorization_locators.INPUT_LOGIN_PERSONAL_AREA).send_keys('+375445624615')

    def delete_symbols(self):
        self.delete_with_js(authorization_locators.INPUT_LOGIN_PERSONAL_AREA, 4)

    def click_proceed_button(self):
        self.waits_clickable_element(authorization_locators.BUTTON_PROCEED_IN_PERSONAL_AREA).click()
    ...
    def enter_login_e_mail(self):
        self.find_element(authorization_locators.INPUT_LOGIN_PERSONAL_AREA).send_keys('applepremiumtest@gmail.com')

    def enter_password_e_mail(self):
        self.find_element(authorization_locators.INPUT_PASSWORD_PERSONAL_AREA).send_keys("apr_test_123123123")
    ...
    def enter_login_google_id(self):
        self.find_element(authorization_locators.INPUT_LOGIN_GOOGLE_ID).send_keys("applepremiumtest@gmail.com")

    def click_button_proceed_in_google_id(self):
        self.waits_clickable_element(authorization_locators.BUTTON_PROCEED_IN_SOCIAL_NETWORK).click()
    ...
    def click_button_facebook(self):
        # time.sleep(1)
        self.waits_clickable_element(authorization_locators.BUTTON_FACEBOOK).click()
    ...
    def click_button_proceed_in_facebook(self):
        self.waits_clickable_element(authorization_locators.BUTTON_PROCEED_FACEBOOK).click()
